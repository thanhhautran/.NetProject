#pragma checksum "C:\Users\Asus\Source\Repos\thanhhautran\.NetProject\WebShop\Areas\Admin\Views\Icon\FontawesomeIcon.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1e5a12ffbc22cccb7d96cb7bfecf38428f64c810"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1e5a12ffbc22cccb7d96cb7bfecf38428f64c810", @"/Areas/Admin/Views/Icon/FontawesomeIcon.cshtml")]
    public class Areas_Admin_Views_Icon_FontawesomeIcon : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\Asus\Source\Repos\thanhhautran\.NetProject\WebShop\Areas\Admin\Views\Icon\FontawesomeIcon.cshtml"
...
<div class=""main-content main-content--pb30"">
    <div class=""section__content section__content--p30"">
        <div class=""container-fluid"">
            ...
            WriteLiteral(@"</div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                           ");
            WriteLiteral(@"     <i class=""fa fa-dot-circle-o""></i> fa-dot-circle-o
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                                <");
            WriteLiteral(@"i class=""fa fa-turkish-lira""></i> fa-turkish-lira
                                <span class=""text-muted"">(alias)</span>
                            </a>
                        </div>
            ...
            WriteLiteral(@"
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                                <i class=");
            WriteLiteral(@"""fa fa-bell-o""></i> fa-bell-o
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                                <i class=""fa fa-bookmark-o""></i> fa-bookmark-");
            WriteLiteral(@"o
                            </a>
                        </div>
         ...
         ");
            WriteLiteral(@"                   </a>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                                <i class=""fa fa-c");
            WriteLiteral(@"aret-square-o-right""></i> fa-caret-square-o-right
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                       ");
            WriteLiteral(@"         <i class=""fa fa-check-circle""></i> fa-check-circle
                            </a>
                        </div>
            ...
            WriteLiteral(@"
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                           ");
            WriteLiteral(@"     <i class=""fa fa-cloud-download""></i> fa-cloud-download
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                             ");
            WriteLiteral(@"   <i class=""fa fa-coffee""></i> fa-coffee
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                                <i class=""fa fa-comment-o""></i> fa-co");
            WriteLiteral(@"mment-o
                            </a>
                        </div>
            ...
            WriteLiteral(@"             <span class=""text-muted"">(alias)</span>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
                                ");
            WriteLiteral(@"<i class=""fa fa-edit""></i> fa-edit
                                <span class=""text-muted"">(alias)</span>
                            </a>
                        </div>
            ...
            WriteLiteral(@" <a href=""#"">
                        ...
                        <div cl");
            WriteLiteral(@"ass=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#"">
     ...
     ");
            ...
            WriteLiteral(@"    <div class=""fa-hover col-lg-3 col-md-6"">
                        ...
                        <div class=""fa-h");
            WriteLiteral(@"over col-lg-3 col-md-6"">
                            <a href=""#"">
            ...
            WriteLiteral(@"           </a>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#lemon-o"">
                                ");
            WriteLiteral(@"<i class=""fa fa-lemon-o""></i> fa-lemon-o
                            </a>
                        </div>
            ...
            WriteLiteral(@"                      </a>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#microphone-slash"">
                                <i class=""fa fa-microph");
            WriteLiteral(@"one-slash""></i> fa-microphone-slash
                            </a>
                        </div>
  ...
  ");
            WriteLiteral(@"                              <i class=""fa fa-minus-square-o""></i> fa-minus-square-o
                            </a>
                        </div>
       ...
       ");
            ...
            WriteLiteral(@"</a>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#puzzle-piece"">
                                <i class=""fa fa-puzzle-piece""></i> fa-puzzl");
            WriteLiteral(@"e-piece
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#quote-left"">
                                <i");
            WriteLiteral(@" class=""fa fa-quote-left""></i> fa-quote-left
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#reply"">
                 ");
            WriteLiteral(@"               <i class=""fa fa-reply""></i> fa-reply
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#rocket"">
                     ");
            WriteLiteral(@"           <i class=""fa fa-rocket""></i> fa-rocket
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#search-minus"">
                    ");
            WriteLiteral(@"            <i class=""fa fa-search-minus""></i> fa-search-minus
                            </a>
                        </div>
...
");
            ...
            WriteLiteral(@">
                        ...
                        <div class=""fa-ho");
            WriteLiteral(@"ver col-lg-3 col-md-6"">
                            <a href=""#sun-o"">
      ...
      ");
            WriteLiteral(@"                  <div class=""fa-hover col-lg-3 col-md-6"">
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#wheelchair"">
                                <i class");
            WriteLiteral(@"=""fa fa-wheelchair""></i> fa-wheelchair
                            </a>
                        </div>
           ...
           ");
            WriteLiteral(@"                     <i class=""fa fa-check-square-o""></i> fa-check-square-o
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                           ");
            WriteLiteral(@" <a href=""#minus-square"">
                                <i class=""fa fa-minus-square""></i> fa-minus-square
                            </a>
                        </div>
                ...
                <section id=""text-editor"">
                    ...
                    <div class=""row fontawesome-icon-list"">
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#align-center"">
                                <i class=""fa fa-align");
            WriteLiteral(@"-center""></i> fa-align-center
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#bold"">
   ");
            WriteLiteral(@"                             <i class=""fa fa-bold""></i> fa-bold
                            </a>
                        </div>
                        ...
                        <div clas");
            WriteLiteral(@"s=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#columns"">
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#outdent"">
                                <i cla");
            WriteLiteral(@"ss=""fa fa-dedent""></i> fa-dedent
                                <span class=""text-muted"">(alias)</span>
                            </a>
                        </div>
     ...
     ");
            WriteLiteral(@"                   <div class=""fa-hover col-lg-3 col-md-6"">
                ...
                <section id=""directional"">
                    <h2 class=""title-2 fontawesome-list__title"">Directional Icons</");
            WriteLiteral(@"h2>
                    ...
                    <div class=""row fontawesome-icon-list"">
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                    ");
            WriteLiteral(@"        <a href=""#angle-double-up"">
                        ...
                        <div");
            WriteLiteral(@" class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#angle-up"">
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#arrow-circle-o-down"">
                                <i class=""fa fa-arrow-circle-o-down""></i> fa-arrow-circle-o");
            WriteLiteral(@"-down
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
       ");
            WriteLiteral(@"                     <a href=""#arrow-circle-right"">
...
");
            WriteLiteral(@"
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#chevron-down"">
                          ");
            WriteLiteral(@"      <i class=""fa fa-chevron-down""></i> fa-chevron-down
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                   ");
            WriteLiteral(@"         <a href=""#hand-o-down"">
    ...
    ");
            WriteLiteral(@"                            <span class=""text-muted"">(alias)</span>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#dropbox"">
                   ");
            WriteLiteral(@"             <i class=""fa fa-dropbox""></i> fa-dropbox
                            </a>
                        </div>
...
");
            ...
            WriteLiteral(@"  </a>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#stack-overflow"">
                                <i class=""fa fa-stack-overflow""></i> fa-stack");
            WriteLiteral(@"-overflow
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#twitter"">
                                <i class=""fa fa");
            WriteLiteral(@"-twitter""></i> fa-twitter
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#weibo"">
                        ");
            WriteLiteral(@"        <i class=""fa fa-weibo""></i> fa-weibo
                            </a>
                        </div>
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                            <a href=""#youtube"">
                     ");
            WriteLiteral(@"           <i class=""fa fa-youtube""></i> fa-youtube
                            </a>
                        </div>
            ...
            WriteLiteral(@"""#ambulance"">
                        ...
                        <div class=""fa-hover col-lg-3 col-md-6"">
                 ");
            WriteLiteral(@"           <a href=""#plus-square"">
                                <i class=""fa fa-plus-square""></i> fa-plus-square
                            </a>
                        </div>
